...
$extension = substr($taskfile,strlen($taskfile)-4,strlen($taskfile));
// allowed extensions
$allowed_extensions = array(".pdf",".PDF",".doc","docx");
// Validation for allowed extensions .in_array() function searches an array for a specific value.
if(!in_array($extension,$allowed_extensions))
{
echo "<script>alert('Invalid format. Only pdf / PDF/ doc / docx format allowed');</script>";
}
else
{
$ntfile=md5($taskfile).time().$extension;
// Code for move image into directory
move_uploaded_file($_FILES["tfile"]["tmp_name"],"taskfiles/".$ntfile);

$sql="insert into tbltask(DeptID,AssignTaskto,TaskPriority,TaskTitle,TaskDescription,TaskEnddate,taskFile)values(:deptid,:emplist,:tpriority,:ttitle,:tdesc,:tedate,:ntfile)";
...
<br>
 ...
 <div class="field">
                              <label class="label_field">File (if any)</label>
